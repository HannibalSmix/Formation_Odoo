...
# traceback.print_exc() -> pour debug c'est bien et pour prod faut faire attention à ce qu'on envoie

# Check les ORM -> securiser injection url, corerule github, modesecurity-crs (owasp)
